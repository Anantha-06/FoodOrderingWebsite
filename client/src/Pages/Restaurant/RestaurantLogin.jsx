...
function RestaurantLogin() {
  ...
  return (
    <Container
      fluid
      className="loginBackground min-vh-100 d-flex align-items-center position-relative overflow-hidden"
    >
      <motion.div
      ...
      <Row className="w-100">
        <Col
          ...
          md={6}
          lg={6}
          className="d-flex justify-content-center align-items-center order-md-1 order-2"
        >
          <motion.div
          ...
          >
            <Card
              className="text-center border-0 shadow-lg p-4 mb-5 bg-body-tertiary rounded-4 animated-card w-100"
              ...
              <Form className="inputBox-width" onSubmit={handleSubmit}>
                ...
                >
                  <Button
                    variant="warning"
                    type="submit"
                    className="py-2 px-4 fs-6 inputBox-width shadow-lg rounded-pill"
                    disabled={loading}
                  >
        ...
        <Col
          ...
          md={6}
          lg={6}
          className="d-flex justify-content-center align-items-center order-md-2 order-1"
        >
          <motion.img
